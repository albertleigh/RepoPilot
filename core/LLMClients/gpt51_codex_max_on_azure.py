"""
GPT-5.1-Codex-Max on Azure OpenAI LLM client implementation.
...
class GPT51CodexMaxOnAzureClient(LLMClient):
    """Adapter for GPT-5.1-Codex-Max on Azure via AzureOpenAI + Responses API."""

    PROVIDER = "GPT-5.1-Codex-Max on Azure"
    ...
    def is_available(self) -> bool:
        _log.info(
            "Testing GPT-5.1-Codex-Max connection "
        ...
        try:
            ...
            _log.exception(
                "GPT-5.1-Codex-Max connection test failed "
                "(endpoint=%s, deployment=%s, api_version=%s)",

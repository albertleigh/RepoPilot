"""
DeepSeek-V3.2 on Azure LLM client implementation.

Uses the ``openai`` SDK's ``OpenAI`` client pointed at an Azure AI
Services endpoint (Chat Completions API).  Mirrors the DeepSeek-V4-Pro
...
class DeepSeekV32OnAzureClient(LLMClient):
    """Adapter for DeepSeek-V3.2 models hosted on Azure."""

    PROVIDER = "DeepSeek-V3.2 on Azure"

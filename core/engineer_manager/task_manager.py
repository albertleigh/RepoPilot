"""
File-backed persistent task board scoped to a workdir.
"""
...
class TaskManager:
    """Each task is a JSON file under ``<workdir>/.tasks/``."""

    def __init__(self, workdir: Path) -> None:
        self._tasks_dir = workdir / ".tasks"
    ...
    def _save(self, task: dict) -> None:
        (self._tasks_dir / f"task_{task['id']}.json").write_text(
